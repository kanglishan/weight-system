...
public class SerialPortUtils implements SerialPortEventListener {
    ...
    public void initConifg(ParamConfig paramConfig) {
            ...
            if (commPortId.getPortType() == CommPortIdentifier.PORT_SERIAL) {
                ...
                if (paramConfig.getSerialNumber().equals(commPortId.getName())) {
                    ...
                    try {
                        ...
                        throw new WeightSystemException("端口被占用");
                    } catch (TooManyListenersException e) {
                        throw new WeightSystemException("监听器过多");
                    } catch (UnsupportedCommOperationException e) {
                        throw new WeightSystemException("不支持的COMM端口操作异常");
                    }
                    // 结束循环
                    break;
                }
        ...
        // 若不存在该串口则抛出异常
        if (!isExsist) {
            throw new WeightSystemException("不存在该串口！");
        }
    }
    ...
    public void readComm() {
        try {
            ...
            throw new WeightSystemException("读取串口数据时发生IO异常");
        }
    }
    ...
    public void sendComm(String data) {
        ...
        try {
            ...
            throw new WeightSystemException("命令格式错误！");
        }
        try {
            ...
            throw new WeightSystemException("找不到串口。");
        } catch (IOException e) {
            throw new WeightSystemException("发送信息到串口时发生IO异常");
        }
    }
        ...
        if (serialPort != null) {
            ...
            if (inputStream != null) {
                try {
                    ...
                    throw new WeightSystemException("关闭输入流时发生IO异常");
                }
            }
            if (outputStream != null) {
                try {
                    ...
                    throw new WeightSystemException("关闭输出流时发生IO异常");
                }
            }
            serialPort.close();
            serialPort = null;
